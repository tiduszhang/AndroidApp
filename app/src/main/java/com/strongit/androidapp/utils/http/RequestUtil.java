...
class RequestUtil {
    ...
    public String mUserName = "";//账户
    public String mPassWord = "";//密码


    RequestUtil(String methodType, String url, Map<String, String> paramsMap, Map<String, String> headerMap, CallBackUtil callBack, String userName , String passWord) {
        this(methodType,url,null,null,null,null,null,null,paramsMap,headerMap,callBack, userName,passWord);
    }

    RequestUtil(String methodType, String url, String jsonStr, Map<String, String> headerMap, CallBackUtil callBack, String userName , String passWord) {
        this(methodType,url,jsonStr,null,null,null,null,null,null,headerMap,callBack, userName,passWord);
    }

    RequestUtil(String methodType, String url, Map<String, String> paramsMap, File file, String fileKey, String fileType, Map<String, String> headerMap, CallBackUtil callBack, String userName , String passWord) {
        this(methodType,url,null,file,null,fileKey,null,fileType,paramsMap,headerMap,callBack,  userName,passWord);
    }
    RequestUtil(String methodType, String url, Map<String, String> paramsMap, List<File> fileList, String fileKey, String fileType, Map<String, String> headerMap, CallBackUtil callBack, String userName , String passWord) {
        this(methodType,url,null,null,fileList,fileKey,null,fileType,paramsMap,headerMap,callBack, userName,passWord);
    }
    RequestUtil(String methodType, String url, Map<String, String> paramsMap, Map<String, File> fileMap, String fileType, Map<String, String> headerMap, CallBackUtil callBack, String userName , String passWord) {
        this(methodType,url,null,null,null,null,fileMap,fileType,paramsMap,headerMap,callBack, userName,passWord);
    }

    private RequestUtil(String methodType, String url, String jsonStr ,File file ,List<File> fileList,String fileKey , Map<String,File> fileMap,String fileType,Map<String, String> paramsMap,Map<String, String> headerMap, CallBackUtil callBack, String userName, String passWord) {
